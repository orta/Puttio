	...
	create: function( options ) {
      ...
      setupCover();
			...
			function setupPositions() {
				menuTransformOpened = '';
				contentsTransformClosed = 'translateX( 0 )';
...
//				dom.cover.style.height = '100%';
        ...
        Meny.bindEvent( dom.cover, 'mousedownCover', onMouseDown );
        Meny.bindEvent( dom.cover, 'mousedownCover', onTouchEnd );
